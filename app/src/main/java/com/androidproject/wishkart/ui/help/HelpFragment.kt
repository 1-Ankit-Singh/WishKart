...
class HelpFragment : Fragment() {
    ...
    private var loginAndProfileBoolean: Boolean = false
    private var sellBoolean: Boolean = false
    private var buyBoolean: Boolean = false
    private var donateBoolean: Boolean = false
    private var doneeBoolean: Boolean = false
    private var noteBoolean: Boolean = false
    ...
    override fun onCreateView(
        ...
        helpBinding.loginAndProfile.setOnClickListener {
            if (!loginAndProfileBoolean) {
                ...
                helpBinding.loginAndProfileText.text = getString(R.string.login_and_profile, loginAndProfile)
                ...
                loginAndProfileBoolean = true
            } else {
                helpBinding.loginAndProfileText.visibility = View.GONE
                helpBinding.loginAndProfile.setBackgroundResource(R.drawable.background_edit_text)
                loginAndProfileBoolean = false
            }
        }
        helpBinding.sell.setOnClickListener {
            if (!sellBoolean) {
                ...
                helpBinding.sellText.visibility = View.GONE
                helpBinding.sell.setBackgroundResource(R.drawable.background_edit_text)
                sellBoolean = false
            }
        }
        helpBinding.buy.setOnClickListener {
            if (!buyBoolean) {
                ...
                helpBinding.buyText.visibility = View.GONE
                helpBinding.buy.setBackgroundResource(R.drawable.background_edit_text)
                buyBoolean = false
            }
        }
        helpBinding.donate.setOnClickListener {
            if (!donateBoolean) {
                ...
                helpBinding.donateText.visibility = View.GONE
                helpBinding.donate.setBackgroundResource(R.drawable.background_edit_text)
                donateBoolean = false
            }
        }
        helpBinding.donee.setOnClickListener {
            if (!doneeBoolean) {
                ...
                helpBinding.doneeText.visibility = View.GONE
                helpBinding.donee.setBackgroundResource(R.drawable.background_edit_text)
                doneeBoolean = false
            }
        }
        helpBinding.note.setOnClickListener {
            if (!noteBoolean) {
                ...
                helpBinding.noteText.visibility = View.GONE
                helpBinding.note.setBackgroundResource(R.drawable.background_edit_text)
                noteBoolean = false
            }
        }
        helpBinding.contactUs.setOnClickListener {
            ...
            intent.putExtra(Intent.EXTRA_SUBJECT, "Query regarding WishKart")
